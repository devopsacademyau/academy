...
aws ec2 run-instances \
    ...
    --key-name MyKeyPair \
    --security-group-ids sg-03e80096433013264 \
    --private-ip-address 172.31.16.12
...

{
    ...
    "Instances": [
        {
            "AmiLaunchIndex": 0,
            "ImageId": "ami-003634241a8fcdec0",
            "InstanceId": "i-030fde7b92b048e74",
            "InstanceType": "t2.micro",
            "KeyName": "MyKeyPair",
            "LaunchTime": "2020-06-13T04:10:11+00:00",
            "Monitoring": {
                "State": "disabled"
            },
            "Placement": {
            ...
            "PrivateDnsName": "ip-172-31-16-12.us-west-2.compute.internal",
            ...
            "NetworkInterfaces": [
                {
                    "Attachment": {
                        "AttachTime": "2020-06-13T04:10:11+00:00",
                        "AttachmentId": "eni-attach-01de62fa0eaebedde",
                        "DeleteOnTermination": true,
                        "DeviceIndex": 0,
                        "Status": "attaching"
                    },
                    ...
                    "Ipv6Addresses": [],
                    "MacAddress": "02:84:38:7d:03:00",
                    "NetworkInterfaceId": "eni-067f8b30048f4bc63",
                    "OwnerId": "873547843801",
                    "PrivateDnsName": "ip-172-31-16-12.us-west-2.compute.internal",
                    "PrivateIpAddress": "172.31.16.12",
                    "PrivateIpAddresses": [
    ...
    "OwnerId": "873547843801",
    "ReservationId": "r-01624fca0dd7b9813"
}
...
```
ssh -i "MyKeyPair.pem" ubuntu@ec2-52-12-177-52.us-west-2.compute.amazonaws.com


The authenticity of host 'ec2-52-12-177-52.us-west-2.compute.amazonaws.com (52.12.177.52)' can't be established.
ECDSA key fingerprint is SHA256:N/1cU3Rq1p1QT4M3CYTJk42w04Xtjx5eVHZrzwSHX6I.
Are you sure you want to continue connecting (yes/no/[fingerprint])? yes
Warning: Permanently added 'ec2-52-12-177-52.us-west-2.compute.amazonaws.com,52.12.177.52' (ECDSA) to the list of known hosts.
Welcome to Ubuntu 18.04.4 LTS (GNU/Linux 4.15.0-1065-aws x86_64)
 ...
 * Support:        https://ubuntu.com/advantage
  ...
  System information as of Sat Jun 13 04:14:24 UTC 2020

  System load:  0.11              Processes:           89
  Usage of /:   13.8% of 7.69GB   Users logged in:     0
  Memory usage: 15%               IP address for eth0: 172.31.16.12
  Swap usage:   0%
