...
vpcCIDRblock               = "10.0.0.0/16"                                      # Specify the CIDR block to be used for VPC creation
public_subnet_cidr_blocks  = ["10.0.10.0/24", "10.0.11.0/24"]                   # List of subnets to be used while creating public subnet
public_subnet_names        = ["public-a", "public-b"]                           # Name of subnets to be used while creating public subnet
private_subnet_cidr_blocks = ["10.0.30.0/24", "10.0.31.0/24"]                   # List of subnets to be used while creating private subnet
