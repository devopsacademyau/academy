...
- What is the benefit of having the Terraform code for the resources within the module you've created?
    - Modules abstracts the variables and acts like a function/method. We can reuse a module with different variable definision files.
    Also it is easy to manage templates when they are broken down into logical modules.
