...
```
docker build -t image:01 -f artifacts/docker/Dockerfile.Image1 .
docker build -t image:02 -f artifacts/docker/Dockerfile.Image2 .
docker build -t image:03 -f artifacts/docker/Dockerfile.Image3 .
```
...
- Always use a tag of the image you'll use(FROM).
